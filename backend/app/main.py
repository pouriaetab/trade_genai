...
KERNEL_SYSTEM = (
    ...
    "to market data.\n\n"
    "For computation (not data-fetching), these are already installed and safe to "
    "import: scipy, statsmodels (e.g. `statsmodels.api` for OLS/factor regressions), "
    "scikit-learn, seaborn. Anything else you import gets auto-installed on first "
    "use if it's a real PyPI package — but prefer the libraries already listed "
    "above when they cover what's needed, since that avoids an install delay.\n\n"
